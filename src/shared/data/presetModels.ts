...
export const presetModels: PresetModel[] = [
  ...
  // Qwen3 系列 (2025年4月发布)
  {
    ...
    name: 'Qwen3 235B',
    provider: 'siliconflow',
    description: '通义千问第三代旗舰MoE模型（235B参数，22B激活），开源最强模型之一。',
    capabilities: ['复杂推理', '代码生成', '内容创作', '多语言支持', 'Agent能力'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
  },
  {
    ...
    name: 'Qwen3 30B MoE',
    provider: 'siliconflow',
    description: '最强开源小MoE模型，适合个人本地部署，性能超越72B Dense模型。',
    capabilities: ['复杂推理', '代码生成', '内容创作', '高效推理'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
  },
  {
    ...
    name: 'Qwen3 32B',
    provider: 'siliconflow',
    description: '通义千问第三代旗舰Dense模型，企业级部署首选，性能超越上一代72B。',
  ...
  },
  {
    ...
    name: 'Qwen3 8B',
    provider: 'siliconflow',
    description: '通义千问第三代轻量级模型，适合电脑端侧部署。',
    capabilities: ['聊天对话', '内容生成', '代码辅助', '快速响应'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
  },
  {
    ...
    name: 'Qwen3 4B',
    provider: 'siliconflow',
    description: '通义千问第三代超轻量模型，可媲美Qwen2.5-72B，适合手机端部署。',
    capabilities: ['聊天对话', '内容生成', '端侧部署', '移动端优化'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
  },
  {
    ...
    name: 'QwQ-32B',
    provider: 'siliconflow',
    description: '基于Qwen2.5-32B的推理模型，推理能力直逼DeepSeek-R1满血版。',
    capabilities: ['思考过程', '复杂推理', '数学推理', '代码生成'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
  },

  // Qwen3-Omni 全模态系列 (2025年9月发布)
  {
    id: 'Qwen/Qwen3-Omni-30B-A3B',
    name: 'Qwen3-Omni 30B',
    provider: 'siliconflow',
    description: '首个原生端到端全模态模型，支持文本、图像、音频、视频输入。',
    capabilities: ['多模态理解', '图像分析', '音频理解', '视频理解', '实时对话'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
    multimodal: true,
  },
  {
    ...
    provider: 'siliconflow',
    description: 'Qwen3-Omni思考版本，支持多模态推理和思考过程展示。',
    capabilities: ['多模态推理', '思考过程', '视觉推理', '音频推理'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.siliconflow.cn/v1',
    multimodal: true,
  },
  ...
  // Grok 模型
  {
    ...
    name: 'Grok-1',
    provider: 'grok',
    description: 'xAI的第一代Grok模型，擅长幽默风格回复和实时信息获取。',
  ...
  },
  {
    ...
    name: 'Grok-2',
    provider: 'grok',
    description: 'xAI的第二代Grok模型，具有增强的推理能力和多模态理解。',
  ...
  },
  {
    ...
    name: 'Grok-3',
    provider: 'grok',
    description: 'xAI最新旗舰模型（2025年），具有卓越的推理能力和多模态理解。',
    capabilities: ['复杂推理', '多模态理解', '代码生成', '实时知识', '高级问题解决'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.x.ai/v1',
    multimodal: true,
  },
  {
    ...
    provider: 'grok',
    description: 'Grok-3的思考增强版本，展示详细的推理过程和思考链。',
    capabilities: ['思考过程', '复杂推理', '问题解决', '代码生成', '逻辑分析'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.x.ai/v1',
  },
  {
    ...
    name: 'Grok-4 Fast',
    provider: 'grok',
    description: 'Grok-4的快速版本，平衡性能与响应速度，适合实时对话。',
    capabilities: ['快速响应', '实时对话', '代码辅助', '基础推理'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.x.ai/v1',
  },
  ...
  // DeepSeek 模型
  {
    ...
    provider: 'deepseek',
    description: 'DeepSeek-V4 旗舰模型（1.6T 总参数 / 49B 激活），开源 SOTA 智能体编码能力，1M 上下文，支持思考/非思考双模式。',
    capabilities: ['复杂推理', '思考过程', '智能体能力', '代码生成', '中文优化', 'JSON输出', '函数调用', '长上下文'],
    requiresApiKey: true,
  ...
  },
  {
    ...
    provider: 'deepseek',
    description: 'DeepSeek-V4 高性价比模型（284B 总参数 / 13B 激活），推理能力接近 V4-Pro，响应更快，1M 上下文，支持思考/非思考双模式。',
    capabilities: ['聊天对话', '思考过程', '代码辅助', '中文优化', 'JSON输出', '函数调用', '长上下文'],
    requiresApiKey: true,
    defaultBaseUrl: 'https://api.deepseek.com',
  },
  {
    ...
    provider: 'deepseek',
    description: '⚠️ 已弃用：将于 2026-07-24 完全停用。当前路由到 deepseek-v4-flash 非思考模式，建议迁移到 deepseek-v4-flash 或 deepseek-v4-pro。',
  ...
  },
  {
    ...
    provider: 'deepseek',
    description: '⚠️ 已弃用：将于 2026-07-24 完全停用。当前路由到 deepseek-v4-flash 思考模式，建议迁移到 deepseek-v4-flash 或 deepseek-v4-pro。',
