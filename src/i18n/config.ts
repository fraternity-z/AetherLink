...
import enSkillsSettings from './locales/en-US/settings/skillsSettings.json';
...
import zhSkillsSettings from './locales/zh-CN/settings/skillsSettings.json';
...
const resources = {
  'zh-CN': {
    translation: mergeModules(
      ...
      { errors: zhErrors },
      { settings: mergeSettingsModules(zhSettings, zhAppearanceSettings, zhVoiceSettings, zhWebSearchSettings, zhMcpServerSettings, { networkProxy: zhNetworkProxySettings }, zhSkillsSettings) },
  ...
  'en-US': {
    translation: mergeModules(
      ...
      { errors: enErrors },
      { settings: mergeSettingsModules(enSettings, enAppearanceSettings, enVoiceSettings, enWebSearchSettings, enMcpServerSettings, { networkProxy: enNetworkProxySettings }, enSkillsSettings) },
